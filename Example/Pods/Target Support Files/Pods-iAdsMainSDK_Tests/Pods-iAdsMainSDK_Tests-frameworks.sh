...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/iAdsSDK/iAdsSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/iComponentsSDK/iComponentsSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/iLogSDK/iLogSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/iReadFileConfigSDK/iReadFileConfigSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/iRemoteConfigSDK/iRemoteConfigSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/iSecuritySDK/iSecuritySDK.framework"
