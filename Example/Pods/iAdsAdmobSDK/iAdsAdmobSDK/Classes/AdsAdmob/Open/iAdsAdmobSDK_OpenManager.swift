...
public class iAdsAdmobSDK_OpenManager: NSObject, iAdsCoreSDK_OpenProtocol {
    ...
    func make() -> iAdsCoreSDK_OpenProtocol {
        return iAdsAdmobSDK_OpenManager()
    }
...
extension iAdsAdmobSDK_OpenManager: GADFullScreenContentDelegate {
